...
export const ADD_USER = gql`
  mutation addUser($username: String!, $email: String!, $password: String!, $profilePicture: String) {
    addUser(username: $username, email: $email, password: $password, profilePicture: $profilePicture) {
      token
      user {
        _id
        username
